...
export const componentStore: Record<string, Component> = {
  ...
  "HeroCarousel": {
    ...
    "props": {
      ...
      "addOnArray": "{\"objects\":{\"dots\":{\"type\":\"dots\",\"containerClass\":\"absolute z-4 translate-y-[-100%] w-full\",\"wrapperClass\":\"\",\"dotContainerClass\":\"\",\"dotsClass\":\"\",\"dotSelectedClass\":\"\"},\"arrows\":{\"type\":\"arrows\",\"containerClass\":\"absolute z-3 h-full top-[50%] translate-y-[-50%] w-full\",\"wrapperClass\":\"\",\"iconButtonClass\":\"\",\"iconClass\":\"\",\"svg\":\"\"}},\"array\":[]}",
      "delay": "50000"
    }
  },
  "MobileNavbar": {
